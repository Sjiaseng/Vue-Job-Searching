...
watch(() => state.job, (newValue) => {
    console.log('Updated Job Info:', newValue);
});
...
<template>
    ...
    <section  v-if="!state.isLoading" class="bg-green-50">
        <div class="container m-auto py-10 px-6">
            <div class="grid grid-cols-1 xl:grid-cols-[68%_30%] w-full gap-6">
                
                <main class="w-full">
                    <div class="bg-white w-full p-6 rounded-lg shadow-md text-center md:text-left">
                ...
                <aside>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p class="my-2 bg-green-100 p-2 font-bold break-words whitespace-normal">
